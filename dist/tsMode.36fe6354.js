...
var _monacoContribution = require("./monaco.contribution.js");
...
function () {
  ...
  LibFiles.prototype.getOrCreateModel = function (uri) {
    ...
    if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
      return _monacoEditorCore.editor.createModel(this._libFiles[uri.path.slice(1)], 'typescript', uri);
    }
...
function (_super) {
  ...
  function DiagnosticsAdapter(_libFiles, _defaults, _selector, worker) {
    ...
    _this._disposables.push(_monacoEditorCore.editor.onDidCreateModel(function (model) {
...
function (_super) {
  ...
  SignatureHelpAdapter._toSignatureHelpTriggerReason = function (context) {
    switch (context.triggerKind) {
      case _monacoEditorCore.languages.SignatureHelpTriggerKind.TriggerCharacter:
      ...
      case _monacoEditorCore.languages.SignatureHelpTriggerKind.ContentChange:
      ...
      case _monacoEditorCore.languages.SignatureHelpTriggerKind.Invoke:
      default:
        return {
          kind: 'invoked'
        };
          ...
          case 3:
            ...
            for (_i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
              ...
              if (refModel) {
                ...
                matchedLibFile = _monacoContribution.typescriptDefaults.getExtraLibs()[entry.fileName];

                if (matchedLibFile) {
                  libModel = _monacoEditorCore.editor.createModel(matchedLibFile.content, 'typescript', uri);
                  return [2
                  /*return*/
                  , {
                    uri: uri,
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            for (_i = 0, renameLocations_1 = renameLocations; _i < renameLocations_1.length; _i++) {
              ...
              resource_1 = _monacoEditorCore.Uri.parse(renameLocation.fileName);
              model_1 = _monacoEditorCore.editor.getModel(resource_1);
...
function (_super) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , worker.provideInlayHints(fileName, start, end)];
  ...
  InlayHintsAdapter.prototype._convertHintKind = function (kind) {
    switch (kind) {
      case 'Parameter':
        return _monacoEditorCore.languages.InlayHintKind.Parameter;

      case 'Type':
        return _monacoEditorCore.languages.InlayHintKind.Type;

      default:
        return _monacoEditorCore.languages.InlayHintKind.Other;
    }
  };
...
},{"./monaco.contribution.js":"node_modules/monaco-editor/esm/vs/language/typescript/monaco.contribution.js","./lib/lib.index.js":"node_modules/monaco-editor/esm/vs/language/typescript/lib/lib.index.js","./fillers/monaco-editor-core.js":"node_modules/monaco-editor/esm/vs/language/typescript/fillers/monaco-editor-core.js"}],"node_modules/monaco-editor/esm/vs/language/typescript/tsMode.js":[function(require,module,exports) {
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function setupMode(defaults, modeId) {
  ...
  _monacoEditorCore.languages.registerInlayHintsProvider(modeId, new languageFeatures.InlayHintsAdapter(worker));
